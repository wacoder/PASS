...
globalsettings_copy = globalinit('sim-verbose'); % best for important simulations (massive logging!)
...
if strcmpi(settings.scenario, 'paris-osf_3+');
   ...
   settings.channel_global.surfaces.wall2.dim    =     2; % normal to y-axis ([x,y,z])
   ...
   switch lower(tagpos)
      case 'line'
         settings.loop.n     = 1; % number of point on trajectory
