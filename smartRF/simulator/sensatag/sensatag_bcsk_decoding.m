...
%
%
% sensatag_room alpha 1.0
%
%************************************************************************************************************************************************
%
%
% ********* Behavior *********
% function sig_d = sensatag_bcsk_decoding( signal, settings)
...
function sig_d = sensatag_bcsk_decoding(varargin)
version = 'beta 3.1';
...
switch settings.m
    ...
    case 1
        ...
        tpri_s = floor(settings.trcal*settings.fs/settings.dr/settings.dsf);
