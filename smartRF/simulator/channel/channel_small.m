...
if ~settings.det
   ...
   if ~isnan(settings.seed)
      ...
      settings.oldDefaultStream = RandStream.getGlobalStream;
      RandStream.setGlobalStream(RandStream('mt19937ar','seed',settings.seed));
   end
   ...
   if ~isnan(settings.seed)
      RandStream.setGlobalStream(settings.oldDefaultStream);
   end
end
