...
%       if (ind_clk(i)<161)||(ind_clk(i)>240&&ind_clk(i)<401)...
%               ||(ind_clk(i)>480&&ind_clk(i)<641)
      if ind_clk(i)<641
                spectrum(:, i) = spectrum(:, i) .* (-hh1); % psk '1'
      else
       spectrum(:, i) = spectrum(:, i) .* hh0; % not modulated ask '0'
      end
   else
      spectrum(:, i) = spectrum(:, i) .* hh1; % modulated ask '1' psk '0'
   end
end
